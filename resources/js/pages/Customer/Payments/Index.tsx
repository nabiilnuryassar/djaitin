            ...
            <div className="space-y-6">
                <div className="rounded-[2rem] bg-white p-8 shadow-[0_20px_80px_rgba(31,23,38,0.08)]">
                    ...
                    <p className="mt-2 max-w-2xl text-sm leading-7 text-slate-600">
                        Gunakan halaman ini untuk melihat semua pembayaran milik
                        customer yang sedang login dan mengunggah bukti ulang
                        jika ada transfer yang ditolak.
                    </p>
                </div>
                ...
                <div className="grid gap-4">
                    {payments.map((payment) => (
                        <Card
                            key={payment.id}
                            className="border-0 bg-white shadow-[0_16px_50px_rgba(31,23,38,0.06)]"
                        >
    ...
    return (
        <div className="grid gap-3 rounded-2xl bg-[#f5f1e8] p-4">
            <div className="grid gap-2">
                <Label htmlFor={`proof-upload-${paymentId}`}>
