# Customer Tailor Configurator — SPEC

## 1. Purpose

Pilih model, kain, ukuran, detail; kalkulasi quote tailor.
...
In scope:
- Halaman dan rute terkait di area: /app/services/tailor, /app/tailor/configurator, /app/tailor/orders
...
```text
orders, fabrics, garment_models, measurements
```
...
```text
/app/services/tailor, /app/tailor/configurator, /app/tailor/orders
```
