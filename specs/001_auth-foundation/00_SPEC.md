...
Fortify-based authentication, registration, password reset, email verification, two-factor.
...
In scope:
- Halaman dan rute terkait di area: /login, /register, /password, /verify-email, /two-factor-challenge, settings/two-factor
...
```text
/login, /register, /password, /verify-email, /two-factor-challenge, settings/two-factor
```
