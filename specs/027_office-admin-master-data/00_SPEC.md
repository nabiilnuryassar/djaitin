# Office Admin Master Data — SPEC

## 1. Purpose

CRUD master: produk, kain, model, kurir, diskon.
...
In scope:
- Halaman dan rute terkait di area: /office/admin/products, fabrics, garment-models, couriers, discounts
...
```text
products, fabrics, garment_models, couriers, discount_policies
```
...
```text
/office/admin/products, fabrics, garment-models, couriers, discounts
```
