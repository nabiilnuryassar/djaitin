# Office Orders Management — SPEC

## 1. Purpose

List/detail/edit order tailor/ready-wear/convection di office, status transition, attachments, audit.
...
In scope:
- Halaman dan rute terkait di area: /office/orders
