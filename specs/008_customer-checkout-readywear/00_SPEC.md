# Customer Checkout (Ready-Wear) — SPEC

## 1. Purpose

Checkout flow ready-wear: alamat, kurir, voucher, DP rules, buat order.
...
In scope:
- Halaman dan rute terkait di area: /app/checkout
...
```text
orders, order_items, addresses, couriers
```
