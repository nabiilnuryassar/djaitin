# Customer Catalog — SPEC

## 1. Purpose

Catalog ready-to-wear: list, detail, filter, stok visible.
...
In scope:
- Halaman dan rute terkait di area: /app/catalog, /app/catalog/{product}
...
```text
products, fabrics, garment_models
```
...
```text
/app/catalog, /app/catalog/{product}
```
