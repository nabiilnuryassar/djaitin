# Attachments & Collaboration — SPEC

## 1. Purpose

Order attachments dengan kategori, kolaborasi revision, linked attachment.
...
In scope:
- Halaman dan rute terkait di area: /app/orders/{order}/attachments, /office/orders/{order}/attachments
...
```text
/app/orders/{order}/attachments, /office/orders/{order}/attachments
```
