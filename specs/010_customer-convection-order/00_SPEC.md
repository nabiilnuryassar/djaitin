# Customer Convection Order — SPEC

## 1. Purpose

Convection request flow dengan brief, attachment, quote pending.
...
In scope:
- Halaman dan rute terkait di area: /app/services/convection, /app/convection/create
...
```text
/app/services/convection, /app/convection/create
```
