# Documents & PDF Generation — SPEC

## 1. Purpose

Invoice/quote/spec sheet via DocumentService + DomPDF.
...
In scope:
- Halaman dan rute terkait di area: /office/orders/{order}/documents/*
