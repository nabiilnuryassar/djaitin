# Customer Orders History — SPEC

## 1. Purpose

List dan detail order milik customer dengan tab status, timeline produksi, lampiran.
...
In scope:
- Halaman dan rute terkait di area: /app/orders, /app/orders/{order}
