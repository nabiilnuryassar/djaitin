# Office Shipping & Fulfillment — SPEC

## 1. Purpose

Set kurir, tracking number, status pengiriman, integrasi dengan order.
...
In scope:
- Halaman dan rute terkait di area: /office/shipping
