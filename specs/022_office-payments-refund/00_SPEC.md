# Office Payments Refund — SPEC

## 1. Purpose

Flow refund pembayaran lewat PaymentRefundService, side effect ke order/stock.
...
In scope:
- Halaman dan rute terkait di area: /office/payments/{payment}/refund
...
```text
/office/payments/{payment}/refund
```
