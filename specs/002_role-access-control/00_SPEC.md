# Role & Access Control — SPEC

## 1. Purpose

UserRole enum, role middleware, role-based redirect at /dashboard, route zones for customer/office/cms.
...
In scope:
- Halaman dan rute terkait di area: /, /dashboard, /app, /office, /cms
