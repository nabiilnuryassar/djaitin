# Customer Profile & Settings — SPEC

## 1. Purpose

Profile edit, password, two-factor, appearance.
...
In scope:
- Halaman dan rute terkait di area: /settings/profile, /settings/password, /settings/two-factor, /settings/appearance, /app/profile
...
```text
/settings/profile, /settings/password, /settings/two-factor, /settings/appearance, /app/profile
```
